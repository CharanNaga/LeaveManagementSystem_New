...
namespace LeaveManagementSystem.Web.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        {
            var data = await _leaveTypesService.GetAll();
            return View(data);
        }
        ...
        public async Task<IActionResult> Create(LeaveTypeCreateVM leaveTypeCreate)
        {
            ...
            if(await _leaveTypesService.CheckIfLeaveTypeNameAlreadyExists(leaveTypeCreate.Name))
            {
        ...
        public async Task<IActionResult> Edit(int id, LeaveTypeEditVM leaveTypeEdit)
        {
            ...
            if (await _leaveTypesService.CheckIfLeaveTypeNameAlreadyExistsForEdit(leaveTypeEdit))
            {
